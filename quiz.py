...
class Quiz:
    ...
    def check_for_correctness(self, user_answer, correct_answer):
        ...
        # Prints the current answer along with current score
    ...
    def load_next_question(self):
        ...
        prepared_question = "Q.{0}:{1}:".format(
            self.question_number, current_question.question_text
        )
        # Prints the question input from questions list
...
def main():
    ...
    for question in quiz_data:
        ...
        # appending all questions to the newly created array questions
        questions.append(prepared_question)
    print("questions are now loaded", questions)

    quiz = Quiz(questions)
    # Run until all the questions have been answered
